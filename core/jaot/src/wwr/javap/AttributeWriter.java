...
import wwr.ast.AccessFlags;
import wwr.ast.AnnotationDefault_attribute;
import wwr.ast.Attribute;
import wwr.ast.Attributes;
import wwr.ast.BootstrapMethods_attribute;
import wwr.ast.CharacterRangeTable_attribute;
import wwr.ast.CharacterRangeTable_attribute.Entry;
import wwr.ast.Code_attribute;
import wwr.ast.CompilationID_attribute;
import wwr.ast.ConstantPool;
import wwr.ast.ConstantPool.CONSTANT_Class_info;
import wwr.ast.ConstantPoolException;
import wwr.ast.ConstantValue_attribute;
import wwr.ast.DefaultAttribute;
import wwr.ast.Deprecated_attribute;
import wwr.ast.EnclosingMethod_attribute;
import wwr.ast.Exceptions_attribute;
import wwr.ast.InnerClasses_attribute;
import wwr.ast.InnerClasses_attribute.Info;
import wwr.ast.LineNumberTable_attribute;
import wwr.ast.LocalVariableTable_attribute;
import wwr.ast.LocalVariableTypeTable_attribute;
import wwr.ast.MethodParameters_attribute;
import wwr.ast.Module_attribute;
import wwr.ast.ModuleHashes_attribute;
import wwr.ast.ModuleMainClass_attribute;
import wwr.ast.ModulePackages_attribute;
import wwr.ast.ModuleResolution_attribute;
import wwr.ast.ModuleTarget_attribute;
import wwr.ast.NestHost_attribute;
import wwr.ast.NestMembers_attribute;
import wwr.ast.RuntimeInvisibleAnnotations_attribute;
import wwr.ast.RuntimeInvisibleParameterAnnotations_attribute;
import wwr.ast.RuntimeInvisibleTypeAnnotations_attribute;
import wwr.ast.RuntimeParameterAnnotations_attribute;
import wwr.ast.RuntimeVisibleAnnotations_attribute;
import wwr.ast.RuntimeVisibleParameterAnnotations_attribute;
import wwr.ast.RuntimeVisibleTypeAnnotations_attribute;
import wwr.ast.Signature_attribute;
import wwr.ast.SourceDebugExtension_attribute;
import wwr.ast.SourceFile_attribute;
import wwr.ast.SourceID_attribute;
import wwr.ast.StackMapTable_attribute;
import wwr.ast.StackMap_attribute;
import wwr.ast.Synthetic_attribute;

import static wwr.ast.AccessFlags.*;
