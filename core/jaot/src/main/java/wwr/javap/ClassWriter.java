...
import wwr.ast.Descriptor;
import wwr.ast.Descriptor.InvalidDescriptor;
import wwr.ast.Exceptions_attribute;
import wwr.ast.Field;
import wwr.ast.Method;
import wwr.ast.Module_attribute;
import wwr.ast.Signature;
import wwr.ast.Signature_attribute;
import wwr.ast.SourceFile_attribute;
import wwr.ast.Type;
import wwr.ast.Type.ArrayType;
import wwr.ast.Type.ClassSigType;
import wwr.ast.Type.ClassType;
import wwr.ast.Type.MethodType;
import wwr.ast.Type.SimpleType;
import wwr.ast.Type.TypeParamType;
import wwr.ast.Type.WildcardType;

import static wwr.ast.AccessFlags.*;
import static wwr.ast.ConstantPool.CONSTANT_Module;
import static wwr.ast.ConstantPool.CONSTANT_Package;
